...
function sumAndMultiply(a,b,c){ //eslint-disable-line
  ...
  var finalSum = sum(sumResult,c);
  var productResult = multiply(a,b);
  var finalProduct = multiply(productResult,c);
  var sumOutput = a + ' and ' + b + ' and ' + c + ' sum to ' + finalSum + '.';
  var productOutput = 'The product of ' + a + ' and ' + b + ' and ' + c + ' is ' + finalProduct + '.';
  return [finalSum, finalProduct, sumOutput, productOutput];
}
